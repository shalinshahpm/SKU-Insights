            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div className="flex-1">
                  <h1 className="text-2xl font-bold tracking-tight mb-1">Welcome to SKU Insights</h1>
                  <p className="text-muted-foreground">Your simplified performance overview</p>
                </div>
                
                <Button 
                  variant="outline" 
                  onClick={() => setShowSimplifiedView(false)}
              ...
              <SimplifiedDashboard 
                onShowFullDashboard={() => setShowSimplifiedView(false)}
                isNewUser={isNewUser}
              />
            </div>
          ) : (
            <>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="mt-4 md:mt-0 flex flex-col sm:flex-row gap-3">
                  <Button 
                    variant="outline" 
                    onClick={() => setShowSimplifiedView(true)}
